...
class Template
{
    ...
    {
        $file = __DIR__ . '/../' . $this->public . '/' . $this->folder . '/public/' . $file . '.php';
        $this->genfile($file);
    }
    ...
    private function parseText($v)
    {
        ...
        return HelperTemplate::printVar(HelperTemplate::langText($text, $array));
    ...
    private function parseUrlImg($templates)
    {
        ...
        return HelperTemplate::printVar(HelperTemplate::imgUrl());
